const json = {
  ...
  "logoHeight": "80px",
  "completedHtml": {
    "pt-br": "<div style=\"max-width: 650px; margin: 40px auto; padding: 25px 40px; background-color: rgba(44, 62, 80, 0.85); color: #FFFFFF; border-radius: 10px; font-family: Arial, sans-serif; box-shadow: 0 4px 15px rgba(0,0,0,0.2); text-align: justify;\"><h2 style=\"margin-top: 0; text-align: center;\">Obrigado pelo seu envio!</h2><p style=\"line-height: 1.6;\">Sua participação é fundamental para que possamos oferecer soluções cada vez mais alinhadas às suas necessidades.</p><p style=\"line-height: 1.6;\">Nossa equipe está analisando as informações fornecidas e, em breve, entraremos em contato para os próximos passos.</p><p style=\"line-height: 1.6;\">Nosso compromisso é garantir uma experiência excepcional, pautada pela excelência no atendimento e na qualidade dos serviços prestados.</p><p style=\"line-height: 1.6;\">Enquanto isso, convidamos você a conhecer mais sobre nossas iniciativas e novidades atravės do nosso site e redes sociais.</p><div style=\"text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.2);\"><a href=\"#\" style=\"color: #FFFFFF; text-decoration: none; margin: 0 15px;\">Website</a><a href=\"#\" style=\"color: #FFFFFF; text-decoration: none; margin: 0 15px;\">LinkedIn</a><a href=\"#\" style=\"color: #FFFFFF; text-decoration: none; margin: 0 15px;\">Instagram</a><a href=\"#\" style=\"color: #FFFFFF; text-decoration: none; margin: 0 15px;\">X</a></div></div>"
  },
  "pages": [
    {
      "name": "page1",
